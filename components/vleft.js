Vue.component('vleft', {
    ...
    <div class="sidebar-box">
        <ul class="uk-nav">
            ...
            <li :class="currentPath.indexOf('collections.html') !== -1 ? 'uk-active' : '' " class="uk-nav-header">Support</li>
            <li :class="currentPath.indexOf('collections.html') !== -1 ? 'uk-active' : '' "><a href="#modal-report" data-uk-toggle><i
                        class="ico_report"></i><span>Privacy</span></a></li>
            <li :class="currentPath.indexOf('collections.html') !== -1 ? 'uk-active' : '' "><a href="#modal-help" data-uk-toggle><i
